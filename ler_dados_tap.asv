...
function [P_base, V_base, num_linhas, num_barras, num_medidas, num_pmedidas, Dados_linhas, Dados_medidas, Dados_pmedidas] = ler_dados_tap(nome_sis)
%||  Ler dados ||
%================
...
Dados_linhas = xlsread(nome_sis, 'Hoja1', strcat( 'A8:F',num2str(num_linhas+7) ));
