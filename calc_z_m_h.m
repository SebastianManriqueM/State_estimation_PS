...
%   EESC/USP - 2017.
function [ h,z_m_h ] = calc_z_m_h( num_barras, num_linhas, num_medidas, nodo_i, nodo_j, Y_barras, b_shunt, I_inj, V_complejo, v_barras, S_calc, z, tipo_m, no_m_i, no_m_j )
%UNTITLED2 Summary of this function goes here
%   Detailed explanation goes here
z_m_h = zeros(num_medidas,1);
h     = zeros(num_medidas,1);

[ S_ij, I_ij, Loses_ij ] = calculo_linhas( num_barras, num_linhas, nodo_i, nodo_j, Y_barras, b_shunt, I_inj, V_complejo, S_calc );
